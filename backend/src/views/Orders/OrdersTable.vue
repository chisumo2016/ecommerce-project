...
<!--        <spinner v-if="orders.loading" class="my-4"></spinner>-->
            ...
            <table class="table-auto w-full">
                ...
                <tr v-for="(order, index) of orders.data" >
                    ...
                    <td class="border-b p-2">
                        <router-link :to="{name: 'app.orders.show', params:{id: order.id} }" class="w-8 h-8 text-indigo-700 rounded-full border-indigo-700  hover:text-white  hover:bg-indigo-700 flex justify-center items-center ">
                            <svg
