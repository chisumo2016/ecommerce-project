...
<!--        <spinner v-if="users.loading" class="my-4"></spinner>-->
            ...
            <table class="table-auto w-full">
                <thead>
                <tr>
                    <TableHeaderCell @click="sortUsers"  class="border-b-2 p-2 text-left" field="id" :sort-field="sortField" :sort-direction="sortDirection">ID</TableHeaderCell>
                    <TableHeaderCell @click="sortUsers('name')"  class="border-b-2 p-2 text-left" field="name" :sort-field="sortField" :sort-direction="sortDirection">Name</TableHeaderCell>
                    <TableHeaderCell @click="sortUsers('email')"  class="border-b-2 p-2 text-left" field="email" :sort-field="sortField" :sort-direction="sortDirection">Email</TableHeaderCell>
                    <TableHeaderCell @click="sortUsers('created_at')"  class="border-b-2 p-2 text-left" field="created_at" :sort-field="sortField" :sort-direction="sortDirection">Createe Date</TableHeaderCell>
...
function getUsers(url = null) {
    store.dispatch('getUsers', { //getUsers executed and get the users
        url ,
        search          : search.value,
